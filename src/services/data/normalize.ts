...
export function normalizeWorkOrder(raw: WorkOrder): NormalizedWorkOrder {
  const flags: DataQualityIssue[] = []; const itemId = normalizedId(raw.itemId);
  if (!itemId) flags.push(issue(itemId, "itemId", "missing_identifier", "Missing monday.com item identifier."));
  const record: NormalizedWorkOrder = { itemId, dealNameMasked: textField(raw.dealNameMasked, "dealNameMasked", itemId, flags), customerNameCode: textField(raw.customerNameCode, "customerNameCode", itemId, flags), serialNumber: textField(raw.serialNumber, "serialNumber", itemId, flags), natureOfWork: textField(raw.natureOfWork, "natureOfWork", itemId, flags), executionStatus: categoryField(raw.executionStatus, "executionStatus", itemId, flags, normalizeStatus), priority: textField(raw.priority, "priority", itemId, flags), dataDeliveryDate: dateField(raw.dataDeliveryDate, "dataDeliveryDate", itemId, flags), poDate: dateField(raw.poDate, "poDate", itemId, flags), documentType: textField(raw.documentType, "documentType", itemId, flags), probableStartDate: dateField(raw.probableStartDate, "probableStartDate", itemId, flags), probableEndDate: dateField(raw.probableEndDate, "probableEndDate", itemId, flags), ownerCode: textField(raw.ownerCode, "ownerCode", itemId, flags), sector: categoryField(raw.sector, "sector", itemId, flags, normalizeSector), typeOfWork: textField(raw.typeOfWork, "typeOfWork", itemId, flags), amountExclGst: numberField(raw.amountExclGst, "amountExclGst", itemId, flags), amountInclGst: numberField(raw.amountInclGst, "amountInclGst", itemId, flags), billedValueExclGst: numberField(raw.billedValueExclGst, "billedValueExclGst", itemId, flags), billedValueInclGst: numberField(raw.billedValueInclGst, "billedValueInclGst", itemId, flags), collectedAmountInclGst: numberField(raw.collectedAmountInclGst, "collectedAmountInclGst", itemId, flags), amountReceivable: numberField(raw.amountReceivable, "amountReceivable", itemId, flags), invoiceStatus: categoryField(raw.invoiceStatus, "invoiceStatus", itemId, flags, normalizeStatus), woStatusBilled: categoryField(raw.woStatusBilled, "woStatusBilled", itemId, flags, normalizeStatus), billingStatus: categoryField(raw.billingStatus, "billingStatus", itemId, flags, normalizeStatus), qualityFlags: flags, isUsableForValueCalc: false, isUsableForDateCalc: false };
